...
neper -T -n from_morpho -domain "cube(0.820,1.000,1.000)" -morpho "tesr:file("${TESR_FN}.tesr")" -morphooptiobjective "tesr:pts(region=surf, res=7)" -morphooptistop itermax=50 -reg 1 -o $TESS_FN
