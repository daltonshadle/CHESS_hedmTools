...
#%%
def meshio_2_neper_mesh(mesh_fn, path, orientations=False):
    '''
    ...
    mesh.cell_data = {"gmsh:physical":grain_id_tags.flatten(),
              "gmsh:geometrical":grain_id_tags.flatten(),
              "cell_tags":grain_id_tags.flatten()}
...
#ori = np.zeros([1123, 3])
#ori[:, :] = np.array([0.509702408490,   -1.526905795462,   -0.789214344347])
...
ori = exp_map2rod(grain_out[:, 3:6].T)
